...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#040412] flex justify-center items-center p-4 '>
        <form method='POST' action="https://getform.io/f/e3b9b708-de84-483b-bc2f-8900fda3225f" className='flex flex-col max-w-[600px] w-full ' >
            ...
            <button className='text-white border-2 hover:bg-violet-600 hover:border-violet-600 px-4 py-3 my-8 mx-auto flex items-center'> Get In Touch!</button>
